...
<table width="100%" border="0">
  <tr>
    <td style="vertical-align: top" width="48%"><div style="border:  solid 1px #000; margin: 0px; padding: 10px; margin: 0px; display: block; font-size: 11px;"> <strong>Anti-Discrimination Notice.</strong> It is illegal to discriminate against
      ...
      <div style="background-color: #c0c0c0;  line-height: 26px; font-weight: bold;">&nbsp;&nbsp;&nbsp;What Is the Purpose of This Form?</div>
      <img src="http://nexmedsolutions.net/system/themes/nexmedicalbackend/images/pdfdemoimg.jpg"  />
      <label style="font-size: 12px; ">The purpose of this form is to document that each new employee (both citizen and noncitizen) hired after November 6, 1986, is authorized to work in the United States.</label>
     <br/>
      <div style="background-color: #c0c0c0;  line-height: 26px; font-weight: bold;">&nbsp;&nbsp;&nbsp;When Should Form I-9 Be Used?</div>
       <br/>
      <label style="font-size: 12px;">All employees (citizens and noncitizens) hired after November
        6, 1986, and working in the United States must complete
        Form I-9.</label>
       <br/>
      <div style="background-color: #c0c0c0;   line-height: 26px; font-weight: bold;">&nbsp;&nbsp;&nbsp;Filling Out Form I-9</div>
       <br/><label style="font-size: 12px;"> <strong>Section 1, Employee</strong></label>
     <br/> <label style="font-size: 12px;">This part of the form must be completed no later than the time
      ...
      <label style="font-size: 12px;"> <strong>Noncitizen nationals of the United States</strong> are persons born in
      ...
      <label style="font-size: 12px;"> <strong>Employers should note</strong> the work authorization expiration
    ...
    <td width="4%">&nbsp;</td>
    <td style="vertical-align: top" width="48%"><label style="font-size: 12px;">in Section 2 evidence of employment authorization that
        contains an expiration date (e.g., Employment Authorization
        Document (Form I-766)). </label>
      <br/><br/>
      <label style="font-size: 12px;"><strong>Preparer/Translator Certification</strong></label>
      <br/><br/>
      <label style="font-size: 12px;">The Preparer/Translator Certification must be completed if <strong>Section 1</strong> is prepared by a person other than the employee. A
      ...
      <br/><br/>
      <label style="font-size: 12px;"><strong>Section 2, Employer</strong> </label>
      <br/><br/>
      <label style="font-size: 12px;">For the purpose of completing this form, the term "employer"
      ...
      <br/> <br/>
      <label style="font-size: 12px;">If an employee is unable to present a required document (or
      ...
      <br/>
      <label style="font-size: 12px;"><strong> <br/>Employers must record in Section 2:</strong> </label>
      <br/>  <br/>
      <label style="list-style: none; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>1.</strong> Document title;</label>
      <br/>
      <label style="list-style: none; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>2.</strong> Issuing authority;</label>
      <br/>
      <label style="list-style: none; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>3.</strong> Document number;</label>
      <br/>
      <label style="list-style: none; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>4.</strong> Expiration date, if any; and</label>
      <br/>
      <label style="list-style: none; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>5.</strong> The date employment begins.</label>
      <br/>
      <label style="font-size: 12px;">Employers must sign and date the certification in <strong>Section 2</strong>. Employees must present original documents. Employers may,
  ...
  <br/>
     ...
     <table width="100%" border="0" >
        <tr>
            <td width="48%"><label style="font-size: 11px;"><strong>For more detailed information, you may refer to the
 ...
 <br/> <br/>
                ...
                <label style="font-size: 11px;"><strong>Section 3, Updating and Reverification</strong></label>
 <br/> <br/>
                <label style="font-size: 11px;">Employers must complete
 ...
 <br/> <br/>
                <label style="font-size: 11px;"><strong>C.</strong>
 ...
 <br/> <br/>
   ...
   <label style="font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>1.</strong>
...
<label style="font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>2.</strong>
Record the document title, document number, and
&nbsp;&nbsp;&nbsp;&nbsp;expiration date (if any) in Block C; and</label><br/>

<label style="font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;<strong> 3.</strong>
Complete the signature block.</label>


<br/><br/>

                <label style="font-size: 11px;">Note that for reverification purposes, employers have the
...
<br/>
                <label style="font-size: 11px;">There is no associated filing fee for completing Form I-9. This
...
<br/>
                <label style="font-size: 11px;">To order USCIS forms, you can download them from our
 ...
 <label style="font-size: 12px;">Information about E-Verify, a free and voluntary program that
...
<br/><br/>
                <label style="font-size: 12px;">General information on immigration laws, regulations, and
...
<br/>
               ...
               <div style="background-color: #c0c0c0;   line-height: 26px; font-weight: bold;">&nbsp;&nbsp;&nbsp;Photocopying and Retaining Form I-9</div>

<br/>
                <label style="font-size: 12px;">A blank Form I-9 may be reproduced, provided both sides are
...
<br/><br/>
                <label style="font-size: 12px;">Form I-9 may be signed and retained electronically, as
                    authorized in Department of Homeland Security regulations
                    at 8 CFR 274a.2.</label>
<br/>
                  <div style="background-color: #c0c0c0; line-height: 26px; font-weight: bold;">&nbsp;&nbsp;&nbsp;Privacy Act Notice</div>
<br/>

                <label style="font-size: 12px;">The authority for collecting this information is the
                    Immigration Reform and Control Act of 1986, Pub. L. 99-603
                    (8 USC 1324a). </label>

<br/><br/>
                <label style="font-size: 12px;">This information will be used by employers as a record of
...
<br/><br/>
                <label style="font-size: 12px;">Submission of the information required in this form is
...
<table width="100%" border="0" style="width: 100%;   border-top: solid 1px #000;"  cellspacing="0" cellpadding="0">
           <tr>
           <td width="75%"><label style="font-size: 11px;">&nbsp;&nbsp;Employee\'s Signature </label></td>
           <td width="25%"><label style="font-size: 11px;">Date <i>(month/day/year)</i> '.@$resi9formdata["employee_date"].'</label></td>
 ...
 '; $html2='<table width="100%" border="0" style="width: 100%;   "  cellspacing="0" cellpadding="0">
           <tr>
           <td width="100%"><label style="font-size: 30px; line-height: 10px;">'.@$resi9formdata["employee_signature"].'</label></td>
...
<table width="100%" border="0" style="  border-bottom: solid 1px #000;  border-top: solid 1px #000;"  cellspacing="0" cellpadding="0">
           <tr>
...
penalty of perjury, that I have assisted in the completion of this form and that to the best of my knowledge the information is true and correct</i> </label></td>
  ...
  <tr>
    <td width="2%">&nbsp;</td>
    <td width="52%" style=" border-top: solid 1px #000;">&nbsp;<label style="font-size: 10px">Preparer\'s/Translator\'s Signature</label></td>
    
    <td width="44%" style=" border-top: solid 1px #000; border-left: solid 1px #000;">&nbsp;<label style="font-size: 10px">Print Name</label>   &nbsp;<u style="font-size: 10px">'.@$resi9formdata["preparer_print_name"].'</u></td>
    <td width="2%">&nbsp;</td>
 ...
 $html4='<table width="100%" border="0" style="width: 100%; "  cellspacing="0" cellpadding="0">
           <tr>
           <td width="2%">&nbsp;</td>
           <td width="52%"><label style="font-size: 30px; line-height: 10px;">'.@$resi9formdata["preparer_signature"].'</label></td>
           <td width="44%" style=" border-left: solid 1px #000;">&nbsp;</td>
            <td width="2%">&nbsp;</td>
           </tr>
...
<label style="font-size: 11px; font-weight:bold;">CERTIFICATION: I attest, under penalty of perjury, that I have examined the document(s) presented by the above-named employee, that
 ...
 <table width="100%" border="0" style="border-top:solid 2px #000;">
            <tr>
                <td width="36%"><label style="font-size: 11px;">Signature of Employer or Authorized Representative</label></td>
                <td width="32%"  style="border-left:solid 2px #000;"><label style="font-size: 11px;">Print Name</label><u style="font-size: 10px">'.@$resi9formdata["employer_print_name"].'</u></td>
                <td width="32%"  style="border-left:solid 2px #000;"><label style="font-size: 11px;">Title</label><u style="font-size: 10px">'.@$resi9formdata["employer_title"].'</u> </td>
            </tr>
        </table>';
                ...
                $html6='<table width="100%" border="0">
            <tr>
                <td width="36.6%">
              <label style="font-size: 30px; line-height: 10px;">'.@$resi9formdata["employer_signature"].'</label>
                 </td>
                <td width="31.7%"  style="border-left:solid 2px #000;">&nbsp;</td>
                <td width="32%"  style="border-left:solid 2px #000;">&nbsp;</td>
            </tr>
        </table>';
...
$html7='
         ...
         <table width="100%" border="0" style="border-top:solid 2px #000; border-bottom:solid 2px #000;">
            <tr>
                <td width="68.5%" style="border-bottom:solid 2px #000;"><label style="font-size: 11px;">Business or Organization Name and Address
                ...
                <td width="31.5%"  style="border-left:solid 2px #000; border-bottom:solid 2px #000;"><label style="font-size: 11px;">Date <i>(month/day/year)
...
<table width="100%" border="0" style="border-top:solid 2px #000; ">
            <tr>
                <td width="68%"><label style="font-size: 11px;">Signature of Employer or Authorized Representative</label></td>
                <td width="32%"  style="border-left:solid 2px #000; "><label style="font-size: 11px;">Date <i>(month/day/year)
                        </i></label> <u style="font-size: 11px;">'.@$resi9formdata["current_employer_date"].'</u> </td>
...
$html8='<table width="100%" border="0" style=" border-bottom:solid 4px #000;">
            <tr>
                <td width="68%" style="border-bottom:solid 4px #000;">
              <label style="font-size: 30px; line-height: 10px;">'.@$resi9formdata["current_employer_sign"].'</label>
</td>
                <td width="32%"  style="border-left:solid 2px #000; border-bottom:solid 4px #000;">&nbsp; </td>
...
<img src="http://nexmedsolutions.net/system/themes/nexmedicalbackend/images/pdfmargin.jpg"  /><br/>
        <table width="100%">
            <tr>
                ...
                <label style="font-size: 14px; font-weight: bold;">LISTS OF ACCEPTABLE DOCUMENTS</label><br/>
        <label style="font-size: 12px; font-weight: bold;">All documents must be unexpired</label>
        </td>
...
text-align: center;
width: 30%;">
                    <label style="font-size: 12px;font-weight: bold;">LIST A</label><br/><br/>
                    <label style="font-size: 12px;font-weight: bold;">Documents that Establish Both<br/>
...
padding: 0 10px;
font-size: 16px;
width: 5%;"><br/><br/><br/><br/><br/><label style="font-size: 12px;font-weight: bold;">OR</label></td>
                <td style="vertical-align: top;
text-align: center;
width: 30%;">
                    <label style="font-size: 12px;font-weight: bold;">LIST B</label><br/><br/>
                    <label style="font-size: 12px;font-weight: bold;">Documents that Establish<br/>
                        Identity </label>
                </td>
                <td style="vertical-align: bottom;
text-align: center;
padding: 0 10px;
font-size: 16px;
width: 5%;"><br/><br/><br/><br/><br/><label style="font-size: 12px;font-weight: bold;">AND</label></td>
                <td style="vertical-align: top;
text-align: center;
width: 30%;">
                    <label style="font-size: 12px;font-weight: bold;">LIST C</label><br/><br/>
                    <label style="font-size: 12px;font-weight: bold;">Documents that Establish<br/>
        ...
        <table width="100%" border="0" style="border: solid 1px #000; font-size: 10px;">
            <tr>
                <td width="33.3%">
...
Employment authorization
          ...
          <table width="100%" border="0" style="border-top: solid 1px #000; font-size: 12px; font-weight: bold;">
            <tr>
                <td width="100%">
<br/>
<div style="border-bottom: solid 2px #000;">Illustrations of many of these documents appear in Part 8 of the Handbook for Employers (M-274)<br/></div>
