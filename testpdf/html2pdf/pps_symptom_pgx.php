...
&nbsp;&nbsp;<span style="display: block"><input type="checkbox" name="box1" id="box1" value="1" readonly="true"  checked="'.$result->pgxval.'" />PGX</span>
 ...
 <td style=" vertical-align: middle;  width: 90px; color: #295b73; font-size: 10px;" valign="bottom">  <u>#'.$result1uniqueid.'</u></td>
  ...
  <td style=" vertical-align: middle;  width:520px; color: #295b73; font-size: 11px;" valign="middle"><span>Green Valley Health Group - 722 Weiland Road Rochester NY 14626
</span>
</td>
</tr>
...
<span style="padding: 0; color: #333;  "><input type="checkbox" name="box" value="1" readonly="true" checked="'.$result4->unabdominalpain.'"/>Unspecified abdominal pain&nbsp;&nbsp;</span>
...
<span style="padding: 0; color: #333;  "><input type="checkbox" name="box" value="1" readonly="true" checked="'.$result4->otherfatigue.'"/>Other fatigue&nbsp;&nbsp;</span>
...
<span style="padding: 0; color: #333;  "><input type="checkbox" name="box" value="1" readonly="true" checked="'.$result4->anemia.'"/>&nbsp;Multiple: Anemia, unspecified&nbsp;&nbsp;</span>
...
<span style="padding: 0; color: #333;  "><input type="checkbox" name="box" value="1" readonly="true" checked="'.$result4->fatigue2.'"/>Other fatigue&nbsp;&nbsp;</span>
...
<span style="padding: 0; color: #333;  "><input type="checkbox" name="box" value="1" readonly="true" checked="'.$result4->constipation.'"/>Constipation, unspecified&nbsp;&nbsp;</span>
